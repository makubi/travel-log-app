...
object DatabaseOpenHelper extends SQLiteOpenHelper(AppStatics.context, DatabaseOpenHelper.DATABASE_NAME, null, Integer.parseInt(DatabaseOpenHelper.CURRENT_DATABASE_VERSION)) {
